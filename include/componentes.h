...
void Conectar_Fuente_T(ArregloFuentes_T *punt_datos, size_t indice_fuentes_T, int nodo_inicio, int nodo_fin);
...
void Conectar_Fuente_C(ArregloFuentes_C *punt_datos, size_t indice_fuentes_C, int nodo_inicio, int nodo_fin);
